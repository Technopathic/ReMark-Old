...
Route::group(['prefix' => 'dashboard'], function()
{
  ...
  Route::get('getSubscriptions', 'UsersController@getSubscriptions');
  Route::post('deleteSubscription', 'UsersController@deleteSubscription');
  ...
  Route::post('postAudio', 'RemarkAdminsController@storeAudio');
  Route::post('postVideo', 'RemarkAdminsController@storeVideo');
  Route::get('editTopic/{id}', 'RemarkAdminsController@editTopic');
  Route::post('updateTopic/{id}','RemarkAdminsController@updateTopic');
  Route::post('updateAudio/{id}', 'RemarkAdminsController@updateAudio');
  Route::post('updateVideo/{id}', 'RemarkAdminsController@updateVideo');
...
Route::group(['prefix' => 'api'], function()
{
    ...
    Route::post('postSubscription', 'AuthenticateController@storeSubscription');
    Route::post('confirmSubscription', 'AuthenticateController@confirmSubscription');
